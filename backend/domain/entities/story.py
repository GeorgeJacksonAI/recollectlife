...
AGE_PHASE_MAPPING = {
    AgeRange.UNDER_18: [
        Phase.GREETING, Phase.AGE_SELECTION,
        Phase.FAMILY_HISTORY, Phase.CHILDHOOD, Phase.ADOLESCENCE,
        Phase.PRESENT, Phase.SYNTHESIS,
    ],
    AgeRange.AGE_18_30: [
        Phase.GREETING, Phase.AGE_SELECTION,
        Phase.FAMILY_HISTORY, Phase.CHILDHOOD, Phase.ADOLESCENCE,
        Phase.EARLY_ADULTHOOD, Phase.PRESENT, Phase.SYNTHESIS,
    ],
    AgeRange.AGE_31_45: [
        Phase.GREETING, Phase.AGE_SELECTION,
        Phase.FAMILY_HISTORY, Phase.CHILDHOOD, Phase.ADOLESCENCE,
        Phase.EARLY_ADULTHOOD, Phase.MIDLIFE, Phase.PRESENT, Phase.SYNTHESIS,
    ],
    AgeRange.AGE_46_60: [
        Phase.GREETING, Phase.AGE_SELECTION,
        Phase.FAMILY_HISTORY, Phase.CHILDHOOD, Phase.ADOLESCENCE,
